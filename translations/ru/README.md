...
Здесь и далее понятия `concurrency` и `parallelism`, несмотря на существующую разницу, будем считать синонимаси и наделять одним смыслом - параллельное выполнение вычислений. 
