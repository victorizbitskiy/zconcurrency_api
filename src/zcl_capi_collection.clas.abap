CLASS zcl_capi_collection DEFINITION
  ...
  PROTECTED SECTION.
    ...
    DATA mt_collection TYPE STANDARD TABLE OF REF TO object .
  PRIVATE SECTION.
ENDCLASS.
...
CLASS ZCL_CAPI_COLLECTION IMPLEMENTATION.
  ...
  METHOD zif_capi_collection~get_item.
    READ TABLE mt_collection INTO ro_result INDEX iv_index.
  ENDMETHOD.
